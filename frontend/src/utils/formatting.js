...
export const STAT_LABELS = {
  // Pitching
  era: 'ERA',
  fip: 'True Pitching Quality',
  xfip: 'Expected Pitching Quality',
  xera: 'Expected ERA',
  k_pct: 'Strikeout Rate',
  bb_pct: 'Walk Rate',
  k_bb_pct: 'Strikeout Edge',
  swstr_pct: 'Swing & Miss Rate',
  csw_pct: 'Stuff Quality',
  hard_hit_pct: 'Hard Contact Rate',
  barrel_pct: 'Damage Rate',
  avg_velo: 'Velocity',
  whiff_pct: 'Whiff Rate',
  // Hitting
  wrc_plus: 'Hitting Power',
  woba: 'Weighted On-Base',
  xba: 'Expected Batting Avg',
  xslg: 'Expected Slugging',
  xwoba: 'Expected Hitting Value',
  avg_exit_velo: 'Exit Velocity',
  o_swing_pct: 'Chase Rate',
  z_contact_pct: 'Strike Zone Contact',
  chase_rate: 'Chase Rate',
  sprint_speed: 'Sprint Speed',
  bsr: 'Baserunning Value',
  babip: 'Batting Luck',
  avg: 'Batting Average',
  ...
  framing_runs: 'Pitch Framing Value',
  // Team
  team_era: 'Team ERA',
  team_fip: 'True Pitching Quality',
  team_wrc_plus: 'Hitting Power',
  team_woba: 'Team Weighted On-Base',
  run_diff: 'Run Margin',
  pythag_wins: 'Expected Wins',
}

/**
 * Technical abbreviations for stats (displayed as subtitles).
 */
export const STAT_ABBREVS = {
  era: 'ERA', fip: 'FIP', xfip: 'xFIP', xera: 'xERA',
  k_pct: 'K%', bb_pct: 'BB%', k_bb_pct: 'K-BB%',
  swstr_pct: 'SwStr%', csw_pct: 'CSW%',
  hard_hit_pct: 'Hard%', barrel_pct: 'Barrel%',
  avg_velo: 'Velo', whiff_pct: 'Whiff%',
  wrc_plus: 'wRC+', woba: 'wOBA', xba: 'xBA', xslg: 'xSLG', xwoba: 'xwOBA',
  avg_exit_velo: 'EV', o_swing_pct: 'O-Swing%', z_contact_pct: 'Z-Contact%',
  chase_rate: 'Chase%', sprint_speed: 'Spd', bsr: 'BsR', babip: 'BABIP',
  avg: 'AVG', obp: 'OBP', slg: 'SLG',
  oaa: 'OAA', drs: 'DRS', framing_runs: 'FRM',
  team_era: 'ERA', team_fip: 'FIP', team_wrc_plus: 'wRC+',
  team_woba: 'wOBA', run_diff: 'R.Diff', pythag_wins: 'PythW',
}
...
export const STAT_EXPLANATIONS = {
  ...
  fip: 'ERA removing luck and defense',
  xfip: 'FIP normalizing home run luck',
  xera: 'Expected ERA from batted ball quality',
  k_pct: 'How often he punches batters out',
  bb_pct: 'How often he gives free bases',
  k_bb_pct: 'Strikeouts minus walks',
  swstr_pct: 'How often batters miss completely',
  csw_pct: 'Called strikes plus whiffs',
  hard_hit_pct: 'Balls hit 95+ mph against',
  barrel_pct: 'Perfect contact percentage',
  avg_velo: 'Fastball speed',
  whiff_pct: 'Swing-and-miss rate',
  wrc_plus: 'League-adjusted value, 100 = average',
  woba: 'Values each outcome by run value',
  xba: 'Expected batting avg from contact quality',
  xslg: 'Expected slugging from contact quality',
  xwoba: 'Expected value from exit velo + launch angle',
  ...
  oaa: 'Outs saved above average fielder',
  drs: 'Defensive runs saved vs average',
